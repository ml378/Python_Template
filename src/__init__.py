...
class IssueTrackerClient(Protocol):
    ...
    def create_issue(self, title: str, description: str, **_kwargs: Any) -> Issue:  # noqa: ANN401
        """Create a new issue and return it."""
        raise NotImplementedError

    def update_issue(self, issue_id: str, **_kwargs: Any) -> Issue:  # noqa: ANN401
...
_instance: IssueTrackerClient | None = None


def get_issue_tracker_client() -> IssueTrackerClient:
    """Return an instance of a mock IssueTrackerClient.

    This demonstrates a basic factory pattern for obtaining the client,
    a step towards dependency injection and interface testing (hw2 revision).
    """
    global _instance  # noqa: PLW0603
    # The linter prefers avoiding globals, but it is invaluable here.

    if _instance is None:
        from .mock_implementation import MockIssueTrackerClient

        _instance = MockIssueTrackerClient()
